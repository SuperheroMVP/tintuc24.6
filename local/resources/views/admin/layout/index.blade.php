...
<head>
    ...
    <script type="text/javascript" language="javascript" src="public/admin_asset/ckfinder/ckfinder.js" ></script>
    <script type="text/javascript">
        var baseURL="{{ asset('') }}";
        
    </script>
    <script type="text/javascript" language="javascript" src="public/admin_asset/js/func_ckfinder.js" ></script>
</head>
